...
const TRANSPORT_MODES: {
  ...
  { id: "car", label: "Coche", icon: Car, osrm: "car" },
  { id: "foot", label: "A pie", icon: Footprints, osrm: "foot" },
  { id: "bike", label: "Bicicleta", icon: Bike, osrm: "bike" },
    ...
    <TooltipProvider>
      <div className="flex flex-col gap-3">
        ...
        <AddressInput
          ...
          value={originText}
          onChange={(v) => { setOriginText(v); setOriginCoord(null); }}
              ...
              if (t.disabled) {
                return (
                  <Tooltip key={t.id}>
                    ...
                    <TooltipContent>
                      <p className="text-xs">Disponible en una fase futura</p>
                    </TooltipContent>
                  </Tooltip>
                );
              }
